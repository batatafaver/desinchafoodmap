  ...
  return (
    <section id="beneficios" className="w-full bg-secondary/30 py-12 sm:py-16">
      <div className="container mx-auto max-w-5xl px-4 text-center">
        ...
        <p className="mt-4 text-base sm:text-lg text-muted-foreground" dangerouslySetInnerHTML={{ __html: 'O <span class="font-bold text-accent">protocolo validado</span> para mulheres de <span class="font-bold text-accent">SACO CHEIO</span> de se sentir estufada, com gases e sem confiança para usar as próprias roupas.' }} />
