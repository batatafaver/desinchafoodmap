      ...
      <div className="container mx-auto max-w-4xl px-4">
        <div className="text-center">
          ...
          <div className="mt-12 text-center">
            ...
            <p className="mt-4 max-w-3xl mx-auto text-base sm:text-lg text-muted-foreground" dangerouslySetInnerHTML={{ __html: 'É um <span class="font-bold">processo validado, simples e aplicável</span>, criado para mulheres que estão cansadas de viver inchadas e querem <span class="font-bold">resultado real, rápido e sustentável.</span>' }} />
        </div>
      </div>
    </section>
  );
