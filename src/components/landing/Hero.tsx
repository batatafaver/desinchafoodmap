...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="w-full">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center text-white">
              <h1 className="font-headline text-2xl sm:text-3xl font-bold tracking-tight [text-shadow:0_1px_3px_rgba(0,0,0,0.4)]">
                <span className="font-extrabold text-yellow-400 [text-shadow:0_1px_2px_rgba(0,0,0,0.5)]">7 dias</span> é tudo o que você precisa para conquistar um <span className="font-extrabold text-yellow-400 [text-shadow:0_1px_2px_rgba(0,0,0,0.5)]">corpo mais leve</span> e dizer <span className="font-extrabold text-yellow-400 [text-shadow:0_1px_2px_rgba(0,0,0,0.5)]">adeus ao inchaço.</span>
              </h1>
              <p className="mt-4 mx-auto max-w-2xl text-sm sm:text-base text-white [text-shadow:0_1px_2px_rgba(0,0,0,0.2)]">
              ...
              <div className="mt-6 flex flex-col items-center justify-center gap-2">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-white"><span className="font-bold">+1.387 mulheres</span> já transformadas</span>
                </div>
                 <p className="text-sm text-white">Acesso imediato e 100% seguro</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="hidden md:flex bg-primary items-center py-24">
        <div className="container mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4">
          <div className="text-center text-white">
            ...
            <p className="mt-4 mx-auto max-w-2xl text-lg md:text-xl text-white [text-shadow:0_1px_2px_rgba(0,0,0,0.2)]">
              Conheça o protocolo que já ajudou <span className="font-bold">milhares de mulheres</span> a eliminar o inchaço abdominal e voltar a se sentir confortáveis no próprio corpo, <span className="font-bold">sem dietas ou treinos malucos.</span>
            </p>
