              ...
              <ul className="mt-6 space-y-4 text-base text-foreground/80">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm">Método validado pra reduzir o inchaço abdominal e sentir o corpo mais leve já na primeira semana.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-5 w-5 mt-1 text-primary flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm">Nada de passar fome, se matar de exercício ou viver cortando tudo.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-5 w-5 mt-1 text-primary flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm">Apoio, troca de experiências e motivação pra você não desistir no meio.</p>
                  </div>
                </li>
                 <li className="flex items-start gap-3">
                  <Check className="h-5 w-5 mt-1 text-primary flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm">(Ou você continua fazendo de conta que é normal viver estufada?) 😈</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Gift className="h-5 w-5 mt-1 text-primary flex-shrink-0" />
                   <div>
                    ...
                    <p className="text-sm">Receitas simples pra aliviar gases e reduzir o estufamento nos momentos mais críticos.</p>
                  </div>
                </li>
                 <li className="flex items-start gap-3">
                  <Gift className="h-5 w-5 mt-1 text-primary flex-shrink-0" />
                   <div>
                    ...
                    <p className="text-sm">Aprenda exatamente o que trocar na alimentação pra não inflamar a barriga — sem radicalismo.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Gift className="h-5 w-5 mt-1 text-primary flex-shrink-0" />
                   <div>
                    ...
                    <p className="text-sm">Um grupo exclusivo pra tirar dúvidas, compartilhar resultados e manter a constância até o fim.</p>
                  </div>
                </li>
              </ul>
            </div>
